...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="mb-1">Create {{ __(Str::singular($title)) }}</h4>

    <div class="col-md">
        <div class="card">
            <h5 class="card-header">Fill the form</h5>
            <div class="card-body">
                <form id="myForm" class="row g-6" method="POST" action="{{ route($route.'store') }}">
                    @csrf
                    @include('back.user-management.users._form')
